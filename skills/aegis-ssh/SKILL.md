...
1. Call `get_ssh_broker_status`. If unavailable or locked, ask the user to run `aegis-ssh daemon` in a terminal. Never ask for the master password or SSH credentials.
